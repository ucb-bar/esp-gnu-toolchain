...
{"vandi",     "Xhwacha", "#d,#s,#j",  MATCH_VANDI, MASK_VANDI, match_opcode,   WR_xd|RD_xs1 },
{"vand",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VAND, MASK_VAND, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vand",      "Xhwacha", "#d,#s,#j",  MATCH_VANDI, MASK_VANDI, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vaddi",     "Xhwacha", "#d,#s,#j",  MATCH_VADDI, MASK_VADDI, match_opcode,  WR_xd|RD_xs1 },
{"vadd",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VADD, MASK_VADD, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vadd",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t,0",MATCH_VADD, MASK_VADD, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vadd",      "Xhwacha", "#d,#s,#j",  MATCH_VADDI, MASK_VADDI, match_opcode,  INSN_ALIAS|WR_xd|RD_xs1 },
{"vslli",     "Xhwacha", "#d,#s,#>",   MATCH_VSLLI, MASK_VSLLI, match_opcode,   WR_xd|RD_xs1 },
{"vsll",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSLL, MASK_VSLL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vsll",      "Xhwacha", "#d,#s,#>",   MATCH_VSLLI, MASK_VSLLI, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vsrli",     "Xhwacha", "#d,#s,#>",   MATCH_VSRLI, MASK_VSRLI, match_opcode,   WR_xd|RD_xs1 },
{"vsrl",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSRL, MASK_VSRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vsrl",      "Xhwacha", "#d,#s,#>",   MATCH_VSRLI, MASK_VSRLI, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vsrai",     "Xhwacha", "#d,#s,#>",   MATCH_VSRAI, MASK_VSRAI, match_opcode,   WR_xd|RD_xs1 },
{"vsra",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSRA, MASK_VSRA, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vsra",      "Xhwacha", "#d,#s,#>",   MATCH_VSRAI, MASK_VSRAI, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vsub",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VSUB, MASK_VSUB, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vori",      "Xhwacha", "#d,#s,#j",  MATCH_VORI, MASK_VORI, match_opcode,   WR_xd|RD_xs1 },
{"vor",       "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VOR, MASK_VOR, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vor",       "Xhwacha", "#d,#s,#j",  MATCH_VORI, MASK_VORI, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vseqz",     "Xhwacha", "#d,#s",  MATCH_VSLTIU | ENCODE_ITYPE_VIMM(1), MASK_VSLTIU | MASK_VIMM, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vsnez",     "Xhwacha", "#N,#p,#v,#x,#d,#t",  MATCH_VSLTU, MASK_VSLTU | MASK_VRS1, match_opcode,   INSN_ALIAS|WR_xd|RD_xs2 },
{"vsltz",     "Xhwacha", "#N,#p,#v,#x,#d,#s",  MATCH_VSLT, MASK_VSLT | MASK_VRS2, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vsgtz",     "Xhwacha", "#N,#p,#v,#x,#d,#t",  MATCH_VSLT, MASK_VSLT | MASK_VRS1, match_opcode,   INSN_ALIAS|WR_xd|RD_xs2 },
{"vslti",     "Xhwacha", "#d,#s,#j",  MATCH_VSLTI, MASK_VSLTI, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vslt",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VSLT, MASK_VSLT, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vslt",      "Xhwacha", "#d,#s,#j",  MATCH_VSLTI, MASK_VSLTI, match_opcode,   WR_xd|RD_xs1 },
{"vsltiu",    "Xhwacha", "#d,#s,#j",  MATCH_VSLTIU, MASK_VSLTIU, match_opcode,   WR_xd|RD_xs1 },
{"vsltu",     "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VSLTU, MASK_VSLTU, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vsltu",     "Xhwacha", "#d,#s,#j",  MATCH_VSLTIU, MASK_VSLTIU, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vsgt",      "Xhwacha", "#N,#p,#v,#x,#d,#t,#s",  MATCH_VSLT, MASK_VSLT, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1|RD_xs2 },
{"vsgtu",     "Xhwacha", "#N,#p,#v,#x,#d,#t,#s",  MATCH_VSLTU, MASK_VSLTU, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1|RD_xs2 },
{"vxori",     "Xhwacha", "#d,#s,#j",  MATCH_VXORI, MASK_VXORI, match_opcode,   WR_xd|RD_xs1 },
{"vxor",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VXOR, MASK_VXOR, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vxor",      "Xhwacha", "#d,#s,#j",  MATCH_VXORI, MASK_VXORI, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vsext.w",   "Xhwacha", "#d,#s",  MATCH_VADDIW, MASK_VADDIW | MASK_VIMM, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vaddiw",    "Xhwacha", "#d,#s,#j",  MATCH_VADDIW, MASK_VADDIW, match_opcode,   WR_xd|RD_xs1 },
{"vaddw",     "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VADDW, MASK_VADDW, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vaddw",     "Xhwacha", "#d,#s,#j",  MATCH_VADDIW, MASK_VADDIW, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vnegw",     "Xhwacha", "#N,#p,#v,#x,#d,#t",  MATCH_VSUBW, MASK_VSUBW | MASK_VRS1, match_opcode,   INSN_ALIAS|WR_xd|RD_xs2 }, /* sub 0 */
{"vslliw",    "Xhwacha", "#d,#s,#<",   MATCH_VSLLIW, MASK_VSLLIW, match_opcode,   WR_xd|RD_xs1 },
{"vsllw",     "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSLLW, MASK_VSLLW, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vsllw",     "Xhwacha", "#d,#s,#<",   MATCH_VSLLIW, MASK_VSLLIW, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vsrliw",    "Xhwacha", "#d,#s,#<",   MATCH_VSRLIW, MASK_VSRLIW, match_opcode,   WR_xd|RD_xs1 },
{"vsrlw",     "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSRLW, MASK_VSRLW, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vsrlw",     "Xhwacha", "#d,#s,#<",   MATCH_VSRLIW, MASK_VSRLIW, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vsraiw",    "Xhwacha", "#d,#s,#<",   MATCH_VSRAIW, MASK_VSRAIW, match_opcode,   WR_xd|RD_xs1 },
{"vsraw",     "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",   MATCH_VSRAW, MASK_VSRAW, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vsraw",     "Xhwacha", "#d,#s,#<",   MATCH_VSRAIW, MASK_VSRAIW, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"vsubw",     "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VSUBW, MASK_VSUBW, match_opcode,   WR_xd|RD_xs1|RD_xs2 },

/* Vector Comparison worker-thread operations */
{"vcmpeq",    "Xhwacha", "#N,#p,#x,#F,#s,#t",    MATCH_VCMPEQ, MASK_VCMPEQ, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vcmplt",    "Xhwacha", "#N,#p,#x,#F,#s,#t",    MATCH_VCMPLT, MASK_VCMPLT, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vcmpltu",   "Xhwacha", "#N,#p,#x,#F,#s,#t",    MATCH_VCMPLTU, MASK_VCMPLTU, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
...
{"vamoswap.w",    "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_W, MASK_VAMOSWAP_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoand.w",     "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_W, MASK_VAMOAND_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoor.w",      "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_W, MASK_VAMOOR_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoxor.w",     "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_W, MASK_VAMOXOR_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomax.w",     "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_W, MASK_VAMOMAX_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomaxu.w",    "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_W, MASK_VAMOMAXU_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomin.w",     "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_W, MASK_VAMOMIN_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamominu.w",    "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_W, MASK_VAMOMINU_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoadd.w.aq",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_W | MASK_VAQ, MASK_VAMOADD_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoswap.w.aq", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_W | MASK_VAQ, MASK_VAMOSWAP_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoand.w.aq",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_W | MASK_VAQ, MASK_VAMOAND_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoor.w.aq",   "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_W | MASK_VAQ, MASK_VAMOOR_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoxor.w.aq",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_W | MASK_VAQ, MASK_VAMOXOR_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomax.w.aq",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_W | MASK_VAQ, MASK_VAMOMAX_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomaxu.w.aq", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_W | MASK_VAQ, MASK_VAMOMAXU_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomin.w.aq",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_W | MASK_VAQ, MASK_VAMOMIN_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamominu.w.aq", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_W | MASK_VAQ, MASK_VAMOMINU_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoadd.w.rl",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_W | MASK_VRL, MASK_VAMOADD_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoswap.w.rl", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_W | MASK_VRL, MASK_VAMOSWAP_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoand.w.rl",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_W | MASK_VRL, MASK_VAMOAND_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoor.w.rl",   "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_W | MASK_VRL, MASK_VAMOOR_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoxor.w.rl",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_W | MASK_VRL, MASK_VAMOXOR_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomax.w.rl",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_W | MASK_VRL, MASK_VAMOMAX_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomaxu.w.rl", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_W | MASK_VRL, MASK_VAMOMAXU_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomin.w.rl",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_W | MASK_VRL, MASK_VAMOMIN_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamominu.w.rl", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_W | MASK_VRL, MASK_VAMOMINU_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoadd.w.sc",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_W | MASK_VAQRL, MASK_VAMOADD_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoswap.w.sc", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_W | MASK_VAQRL, MASK_VAMOSWAP_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoand.w.sc",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_W | MASK_VAQRL, MASK_VAMOAND_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoor.w.sc",   "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_W | MASK_VAQRL, MASK_VAMOOR_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoxor.w.sc",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_W | MASK_VAQRL, MASK_VAMOXOR_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomax.w.sc",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_W | MASK_VAQRL, MASK_VAMOMAX_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomaxu.w.sc", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_W | MASK_VAQRL, MASK_VAMOMAXU_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomin.w.sc",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_W | MASK_VAQRL, MASK_VAMOMIN_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamominu.w.sc", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_W | MASK_VAQRL, MASK_VAMOMINU_W | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoadd.d",     "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_D, MASK_VAMOADD_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoswap.d",    "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_D, MASK_VAMOSWAP_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoand.d",     "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_D, MASK_VAMOAND_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoor.d",      "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_D, MASK_VAMOOR_D | MASK_VAQRL, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vamoxor.d",     "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_D, MASK_VAMOXOR_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomax.d",     "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_D, MASK_VAMOMAX_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomaxu.d",    "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_D, MASK_VAMOMAXU_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomin.d",     "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_D, MASK_VAMOMIN_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamominu.d",    "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_D, MASK_VAMOMINU_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoadd.d.aq",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_D | MASK_VAQ, MASK_VAMOADD_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoswap.d.aq", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_D | MASK_VAQ, MASK_VAMOSWAP_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoand.d.aq",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_D | MASK_VAQ, MASK_VAMOAND_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoor.d.aq",   "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_D | MASK_VAQ, MASK_VAMOOR_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoxor.d.aq",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_D | MASK_VAQ, MASK_VAMOXOR_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomax.d.aq",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_D | MASK_VAQ, MASK_VAMOMAX_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomaxu.d.aq", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_D | MASK_VAQ, MASK_VAMOMAXU_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomin.d.aq",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_D | MASK_VAQ, MASK_VAMOMIN_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamominu.d.aq", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_D | MASK_VAQ, MASK_VAMOMINU_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoadd.d.rl",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_D | MASK_VRL, MASK_VAMOADD_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoswap.d.rl", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_D | MASK_VRL, MASK_VAMOSWAP_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoand.d.rl",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_D | MASK_VRL, MASK_VAMOAND_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoor.d.rl",   "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_D | MASK_VRL, MASK_VAMOOR_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoxor.d.rl",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_D | MASK_VRL, MASK_VAMOXOR_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomax.d.rl",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_D | MASK_VRL, MASK_VAMOMAX_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomaxu.d.rl", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_D | MASK_VRL, MASK_VAMOMAXU_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomin.d.rl",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_D | MASK_VRL, MASK_VAMOMIN_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamominu.d.rl", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_D | MASK_VRL, MASK_VAMOMINU_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoadd.d.sc",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOADD_D | MASK_VAQRL, MASK_VAMOADD_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoswap.d.sc", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOSWAP_D | MASK_VAQRL, MASK_VAMOSWAP_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoand.d.sc",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOAND_D | MASK_VAQRL, MASK_VAMOAND_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoor.d.sc",   "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOOR_D | MASK_VAQRL, MASK_VAMOOR_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamoxor.d.sc",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOXOR_D | MASK_VAQRL, MASK_VAMOXOR_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomax.d.sc",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAX_D | MASK_VAQRL, MASK_VAMOMAX_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomaxu.d.sc", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMAXU_D | MASK_VAQRL, MASK_VAMOMAXU_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamomin.d.sc",  "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMIN_D | MASK_VAQRL, MASK_VAMOMIN_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },
{"vamominu.d.sc", "Xhwacha", "#N,#p,#v,#x,#d,0(#s),#t",  MATCH_VAMOMINU_D | MASK_VAQRL, MASK_VAMOMINU_D | MASK_VAQRL, match_opcode,   WR_xd|RD_xs1|RD_xs2 },

/* Multiply/Divide instruction subset */
{"vmul",       "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VMUL, MASK_VMUL, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vmulh",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VMULH, MASK_VMULH, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vmulhu",     "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VMULHU, MASK_VMULHU, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vmulhsu",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VMULHSU, MASK_VMULHSU, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vdiv",       "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VDIV, MASK_VDIV, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vdivu",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VDIVU, MASK_VDIVU, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vrem",       "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VREM, MASK_VREM, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vremu",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VREMU, MASK_VREMU, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vmulw",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VMULW, MASK_VMULW, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vdivw",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VDIVW, MASK_VDIVW, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vdivuw",     "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VDIVUW, MASK_VDIVUW, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vremw",      "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VREMW, MASK_VREMW, match_opcode,  WR_xd|RD_xs1|RD_xs2 },
{"vremuw",     "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VREMUW, MASK_VREMUW, match_opcode,  WR_xd|RD_xs1|RD_xs2 },

/* Single-precision floating-point instruction subset */
{"vfmv.s",     "Xhwacha", "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJ_S, MASK_VFSGNJ_S, match_rs1_eq_rs2,   INSN_ALIAS|WR_fd|RD_fs1|RD_fs2 },
{"vfneg.s",    "Xhwacha", "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJN_S, MASK_VFSGNJN_S, match_rs1_eq_rs2,   INSN_ALIAS|WR_fd|RD_fs1|RD_fs2 },
{"vfabs.s",    "Xhwacha", "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJX_S, MASK_VFSGNJX_S, match_rs1_eq_rs2,   INSN_ALIAS|WR_fd|RD_fs1|RD_fs2 },
{"vfsgnj.s",   "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJ_S, MASK_VFSGNJ_S, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfsgnjn.s",  "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJN_S, MASK_VFSGNJN_S, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfsgnjx.s",  "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJX_S, MASK_VFSGNJX_S, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfadd.s",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_S | MASK_VRM, MASK_VFADD_S | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfadd.s",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_S, MASK_VFADD_S, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfsub.s",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_S | MASK_VRM, MASK_VFSUB_S | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfsub.s",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_S, MASK_VFSUB_S, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfmul.s",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_S | MASK_VRM, MASK_VFMUL_S | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfmul.s",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_S, MASK_VFMUL_S, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfdiv.s",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFDIV_S | MASK_VRM, MASK_VFDIV_S | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfdiv.s",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFDIV_S, MASK_VFDIV_S, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfsqrt.s",   "Xhwacha", "#N,#p,#v,#w,#d,#s",  MATCH_VFSQRT_S | MASK_VRM, MASK_VFSQRT_S | MASK_VRM, match_opcode,  WR_fd|RD_fs1 },
{"vfsqrt.s",   "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFSQRT_S, MASK_VFSQRT_S, match_opcode,  WR_fd|RD_fs1 },
{"vfmin.s",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMIN_S, MASK_VFMIN_S, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfmax.s",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMAX_S, MASK_VFMAX_S, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfmadd.s",   "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMADD_S | MASK_VRM, MASK_VFMADD_S | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmadd.s",   "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMADD_S, MASK_VFMADD_S, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmadd.s",  "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMADD_S | MASK_VRM, MASK_VFNMADD_S | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmadd.s",  "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMADD_S, MASK_VFNMADD_S, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmsub.s",   "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMSUB_S | MASK_VRM, MASK_VFMSUB_S | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmsub.s",   "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMSUB_S, MASK_VFMSUB_S, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmsub.s",  "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMSUB_S | MASK_VRM, MASK_VFNMSUB_S | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmsub.s",  "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMSUB_S, MASK_VFNMSUB_S, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfclass.s",  "Xhwacha", "#N,#p,#v,#w,#d,#s",  MATCH_VFCLASS_S, MASK_VFCLASS_S, match_opcode,   WR_xd|RD_fs1 },
{"vcmpfeq.s",  "Xhwacha", "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFEQ_S, MASK_VCMPFEQ_S, match_opcode,  WR_xd|RD_fs1|RD_fs2 },
{"vcmpflt.s",  "Xhwacha", "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLT_S, MASK_VCMPFLT_S, match_opcode,  WR_xd|RD_fs1|RD_fs2 },
{"vcmpfle.s",  "Xhwacha", "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLE_S, MASK_VCMPFLE_S, match_opcode,  WR_xd|RD_fs1|RD_fs2 },
{"vcmpfgt.s",  "Xhwacha", "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLT_S, MASK_VCMPFLT_S, match_opcode,  WR_xd|RD_fs1|RD_fs2 },
{"vcmpfge.s",  "Xhwacha", "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLE_S, MASK_VCMPFLE_S, match_opcode,  WR_xd|RD_fs1|RD_fs2 },
{"vfcvt.w.s",  "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_W_S | MASK_VRM, MASK_VFCVT_W_S | MASK_VRM, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.w.s",  "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_W_S, MASK_VFCVT_W_S, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.wu.s", "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_WU_S | MASK_VRM, MASK_VFCVT_WU_S | MASK_VRM, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.wu.s", "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_WU_S, MASK_VFCVT_WU_S, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.s.w",  "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_S_W | MASK_VRM, MASK_VFCVT_S_W | MASK_VRM, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.s.w",  "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_S_W, MASK_VFCVT_S_W, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.s.wu", "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_S_WU | MASK_VRM, MASK_VFCVT_S_W | MASK_VRM, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.s.wu", "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_S_WU, MASK_VFCVT_S_WU, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.l.s",  "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_L_S | MASK_VRM, MASK_VFCVT_L_S | MASK_VRM, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.l.s",  "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_L_S, MASK_VFCVT_L_S, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.lu.s", "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_LU_S | MASK_VRM, MASK_VFCVT_LU_S | MASK_VRM, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.lu.s", "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_LU_S, MASK_VFCVT_LU_S, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.s.l",  "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_S_L | MASK_VRM, MASK_VFCVT_S_L | MASK_VRM, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.s.l",  "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_S_L, MASK_VFCVT_S_L, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.s.lu", "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_S_LU | MASK_VRM, MASK_VFCVT_S_L | MASK_VRM, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.s.lu", "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_S_LU, MASK_VFCVT_S_LU, match_opcode,   WR_fd|RD_xs1 },

/* Double-precision floating-point instruction subset */
{"vfmv.d",     "Xhwacha", "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJ_D, MASK_VFSGNJ_D, match_rs1_eq_rs2,   INSN_ALIAS|WR_fd|RD_fs1|RD_fs2 },
{"vfneg.d",    "Xhwacha", "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJN_D, MASK_VFSGNJN_D, match_rs1_eq_rs2,   INSN_ALIAS|WR_fd|RD_fs1|RD_fs2 },
{"vfabs.d",    "Xhwacha", "#N,#p,#v,#x,#d,#u",  MATCH_VFSGNJX_D, MASK_VFSGNJX_D, match_rs1_eq_rs2,   INSN_ALIAS|WR_fd|RD_fs1|RD_fs2 },
{"vfsgnj.d",   "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJ_D, MASK_VFSGNJ_D, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfsgnjn.d",  "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJN_D, MASK_VFSGNJN_D, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfsgnjx.d",  "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJX_D, MASK_VFSGNJX_D, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfadd.d",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_D | MASK_VRM, MASK_VFADD_D | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfadd.d",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_D, MASK_VFADD_D, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfsub.d",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_D | MASK_VRM, MASK_VFSUB_D | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfsub.d",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_D, MASK_VFSUB_D, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfmul.d",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_D | MASK_VRM, MASK_VFMUL_D | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfmul.d",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_D, MASK_VFMUL_D, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfdiv.d",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFDIV_D | MASK_VRM, MASK_VFDIV_D | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfdiv.d",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFDIV_D, MASK_VFDIV_D, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfsqrt.d",   "Xhwacha", "#N,#p,#v,#w,#d,#s",  MATCH_VFSQRT_D | MASK_VRM, MASK_VFSQRT_D | MASK_VRM, match_opcode,  WR_fd|RD_fs1 },
{"vfsqrt.d",   "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFSQRT_D, MASK_VFSQRT_D, match_opcode,  WR_fd|RD_fs1 },
{"vfmin.d",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMIN_D, MASK_VFMIN_D, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfmax.d",    "Xhwacha", "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMAX_D, MASK_VFMAX_D, match_opcode,   WR_fd|RD_fs1|RD_fs2 },
{"vfmadd.d",   "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMADD_D | MASK_VRM, MASK_VFMADD_D | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmadd.d",   "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMADD_D, MASK_VFMADD_D, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmadd.d",  "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMADD_D | MASK_VRM, MASK_VFNMADD_D | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmadd.d",  "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMADD_D, MASK_VFNMADD_D, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmsub.d",   "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMSUB_D | MASK_VRM, MASK_VFMSUB_D | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmsub.d",   "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMSUB_D, MASK_VFMSUB_D, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmsub.d",  "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMSUB_D | MASK_VRM, MASK_VFNMSUB_D | MASK_VRM, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmsub.d",  "Xhwacha", "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMSUB_D, MASK_VFNMSUB_D, match_opcode,   WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfcvt.d.s",  "Xhwacha", "#N,#p,#v,#w,#d,#s",  MATCH_VFCVT_D_S, MASK_VFCVT_D_S | MASK_VRM, match_opcode,   WR_fd|RD_fs1 },
{"vfcvt.s.d",  "Xhwacha", "#N,#p,#v,#w,#d,#s",  MATCH_VFCVT_S_D | MASK_VRM, MASK_VFCVT_S_D | MASK_VRM, match_opcode,   WR_fd|RD_fs1 },
{"vfcvt.s.d",  "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_S_D, MASK_VFCVT_S_D, match_opcode,   WR_fd|RD_fs1 },
{"vfclass.d",  "Xhwacha", "#N,#p,#v,#w,#d,#s",  MATCH_VFCLASS_D, MASK_VFCLASS_D, match_opcode,   WR_xd|RD_fs1 },
{"vcmpfeq.d",  "Xhwacha", "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFEQ_D, MASK_VCMPFEQ_D, match_opcode,  WR_xd|RD_fs1|RD_fs2 },
{"vcmpflt.d",  "Xhwacha", "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLT_D, MASK_VCMPFLT_D, match_opcode,  WR_xd|RD_fs1|RD_fs2 },
{"vcmpfle.d",  "Xhwacha", "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLE_D, MASK_VCMPFLE_D, match_opcode,  WR_xd|RD_fs1|RD_fs2 },
{"vcmpfgt.d",  "Xhwacha", "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLT_D, MASK_VCMPFLT_D, match_opcode,  WR_xd|RD_fs1|RD_fs2 },
{"vcmpfge.d",  "Xhwacha", "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLE_D, MASK_VCMPFLE_D, match_opcode,  WR_xd|RD_fs1|RD_fs2 },
{"vfcvt.w.d",  "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_W_D | MASK_VRM, MASK_VFCVT_W_D | MASK_VRM, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.w.d",  "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_W_D, MASK_VFCVT_W_D, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.wu.d", "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_WU_D | MASK_VRM, MASK_VFCVT_WU_D | MASK_VRM, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.wu.d", "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_WU_D, MASK_VFCVT_WU_D, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.d.w",  "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_D_W | MASK_VRM, MASK_VFCVT_D_W | MASK_VRM, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.d.w",  "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_D_W, MASK_VFCVT_D_W, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.d.wu", "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_D_WU | MASK_VRM, MASK_VFCVT_D_W | MASK_VRM, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.d.wu", "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_D_WU, MASK_VFCVT_D_WU, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.l.d",  "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_L_D | MASK_VRM, MASK_VFCVT_L_D | MASK_VRM, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.l.d",  "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_L_D, MASK_VFCVT_L_D, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.lu.d", "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_LU_D | MASK_VRM, MASK_VFCVT_LU_D | MASK_VRM, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.lu.d", "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_LU_D, MASK_VFCVT_LU_D, match_opcode,  WR_xd|RD_fs1 },
{"vfcvt.d.l",  "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_D_L | MASK_VRM, MASK_VFCVT_D_L | MASK_VRM, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.d.l",  "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_D_L, MASK_VFCVT_D_L, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.d.lu", "Xhwacha", "#N,#p,#v,#w,#d,#s",     MATCH_VFCVT_D_LU | MASK_VRM, MASK_VFCVT_D_L | MASK_VRM, match_opcode,   WR_fd|RD_xs1 },
{"vfcvt.d.lu", "Xhwacha", "#N,#p,#v,#w,#d,#s,#m",  MATCH_VFCVT_D_LU, MASK_VFCVT_D_LU, match_opcode,   WR_fd|RD_xs1 },

/* Half-precision floating-point instruction subset */
{"vfsgnj.h",   "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJ_H, MASK_VFSGNJ_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfsgnjn.h",  "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJN_H, MASK_VFSGNJN_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfsgnjx.h",  "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSGNJX_H, MASK_VFSGNJX_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfadd.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_H | MASK_VRM, MASK_VFADD_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfadd.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_H, MASK_VFADD_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfsub.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_H | MASK_VRM, MASK_VFSUB_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfsub.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_H, MASK_VFSUB_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmul.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_H | MASK_VRM, MASK_VFMUL_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmul.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_H, MASK_VFMUL_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfdiv.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFDIV_H | MASK_VRM, MASK_VFDIV_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfdiv.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFDIV_H, MASK_VFDIV_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
...
{"vfmin.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMIN_H, MASK_VFMIN_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmax.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMAX_H, MASK_VFMAX_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmadd.h",   "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMADD_H | MASK_VRM, MASK_VFMADD_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmadd.h",   "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMADD_H, MASK_VFMADD_H, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmadd.h",  "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMADD_H | MASK_VRM, MASK_VFNMADD_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmadd.h",  "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMADD_H, MASK_VFNMADD_H, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmsub.h",   "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMSUB_H | MASK_VRM, MASK_VFMSUB_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmsub.h",   "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMSUB_H, MASK_VFMSUB_H, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmsub.h",  "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMSUB_H | MASK_VRM, MASK_VFNMSUB_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmsub.h",  "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMSUB_H, MASK_VFNMSUB_H, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
...
{"vcmpfeq.h",  "Xhwacha",   "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFEQ_H, MASK_VCMPFEQ_H, match_opcode, WR_xd|RD_fs1|RD_fs2 },
{"vcmpflt.h",  "Xhwacha",   "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLT_H, MASK_VCMPFLT_H, match_opcode, WR_xd|RD_fs1|RD_fs2 },
{"vcmpfle.h",  "Xhwacha",   "#N,#p,#x,#F,#s,#t",    MATCH_VCMPFLE_H, MASK_VCMPFLE_H, match_opcode, WR_xd|RD_fs1|RD_fs2 },
{"vcmpfgt.h",  "Xhwacha",   "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLT_H, MASK_VCMPFLT_H, match_opcode, WR_xd|RD_fs1|RD_fs2 },
{"vcmpfge.h",  "Xhwacha",   "#N,#p,#x,#F,#t,#s",    MATCH_VCMPFLE_H, MASK_VCMPFLE_H, match_opcode, WR_xd|RD_fs1|RD_fs2 },
...
{"vfadd.s.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_S_H | MASK_VRM, MASK_VFADD_S_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfadd.s.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_S_H, MASK_VFADD_S_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfsub.s.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_S_H | MASK_VRM, MASK_VFSUB_S_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfsub.s.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_S_H, MASK_VFSUB_S_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmul.s.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_S_H | MASK_VRM, MASK_VFMUL_S_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmul.s.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_S_H, MASK_VFMUL_S_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfadd.d.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_D_H | MASK_VRM, MASK_VFADD_D_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfadd.d.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_D_H, MASK_VFADD_D_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfsub.d.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_D_H | MASK_VRM, MASK_VFSUB_D_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfsub.d.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_D_H, MASK_VFSUB_D_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmul.d.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_D_H | MASK_VRM, MASK_VFMUL_D_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmul.d.h",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_D_H, MASK_VFMUL_D_H, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmadd.d.h",   "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMADD_D_H | MASK_VRM, MASK_VFMADD_D_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmadd.d.h",   "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMADD_D_H, MASK_VFMADD_D_H, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmadd.d.h",  "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMADD_D_H | MASK_VRM, MASK_VFNMADD_D_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmadd.d.h",  "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMADD_D_H, MASK_VFNMADD_D_H, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmsub.d.h",   "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFMSUB_D_H | MASK_VRM, MASK_VFMSUB_D_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfmsub.d.h",   "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFMSUB_D_H, MASK_VFMSUB_D_H, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmsub.d.h",  "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r",  MATCH_VFNMSUB_D_H | MASK_VRM, MASK_VFNMSUB_D_H | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfnmsub.d.h",  "Xhwacha",   "#N,#p,#v,#y,#d,#s,#t,#r,#m",  MATCH_VFNMSUB_D_H, MASK_VFNMSUB_D_H, match_opcode,  WR_fd|RD_fs1|RD_fs2|RD_fs3 },
{"vfadd.d.s",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFADD_D_S | MASK_VRM, MASK_VFADD_D_S | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfadd.d.s",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFADD_D_S, MASK_VFADD_D_S, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfsub.d.s",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFSUB_D_S | MASK_VRM, MASK_VFSUB_D_S | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfsub.d.s",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFSUB_D_S, MASK_VFSUB_D_S, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmul.d.s",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t",  MATCH_VFMUL_D_S | MASK_VRM, MASK_VFMUL_D_S | MASK_VRM, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
{"vfmul.d.s",    "Xhwacha",   "#N,#p,#v,#x,#d,#s,#t,#m",  MATCH_VFMUL_D_S, MASK_VFMUL_D_S, match_opcode,  WR_fd|RD_fs1|RD_fs2 },
